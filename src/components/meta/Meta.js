...
const Meta = ({ title }) => {
  ...
  return (
    <Head>
      ...
      <meta
        name="twitter:image"
        content="https://raw.githubusercontent.com/Maksydenko/todo/master/public/todo.svg"
      />
      ...
      {/* Name of the site */}
      <meta property="og:site_name" content="To do | Maksydenko" />
      <title>{getTitle(title)}</title>
      <link rel="apple-touch-icon" href="/todo.svg" />
